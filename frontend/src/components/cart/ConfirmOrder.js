    ...
    return (
        <Fragment>
            ...
            <div className="col-12 col-lg-8 mt-5 order-confirm">
                ...
                <h4 className="mb-3">Delivering Info</h4>
                <p><b>Name:</b> {user.name}</p>
                <p><b>Phone:</b> {shippingInfo.phoneNo}</p>
                <p className="mb-4"><b>Address:</b> {shippingInfo.address},  {shippingInfo.city},  {shippingInfo.postalCode},  {shippingInfo.state},  {shippingInfo.province} </p>
            ...
            <div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <p>Delivery Charge: <span className="order-summary-values">Rs.{shippingPrice}</span></p>
